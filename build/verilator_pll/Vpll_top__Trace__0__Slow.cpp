...
VL_ATTR_COLD void Vpll_top___024root__trace_init_sub__TOP__0(Vpll_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+30,0,"STATE_IDLE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+31,0,"STATE_UP",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+32,0,"STATE_DOWN",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
...
VL_ATTR_COLD void Vpll_top___024root__trace_register(Vpll_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vpll_top___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vpll_top___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vpll_top___024root__trace_chg_0, 0, vlSelf);
...
VL_ATTR_COLD void Vpll_top___024root__trace_const_0_sub_0(Vpll_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+29,(0x00000020U),32);
    bufp->fullCData(oldp+30,(0U),2);
    bufp->fullCData(oldp+31,(1U),2);
    bufp->fullCData(oldp+32,(2U),2);
}
...
VL_ATTR_COLD void Vpll_top___024root__trace_full_0_sub_0(Vpll_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullCData(oldp+1,(vlSelfRef.pll_top__DOT__pfd_error),4);
    bufp->fullBit(oldp+2,(vlSelfRef.pll_top__DOT__pfd_sample));
    bufp->fullIData(oldp+3,(vlSelfRef.pll_top__DOT__dco_ctrl_word),32);
    bufp->fullBit(oldp+4,(vlSelfRef.pll_top__DOT__internal_lock));
    bufp->fullCData(oldp+5,(vlSelfRef.pll_top__DOT__dynamic_kp),5);
    bufp->fullCData(oldp+6,(vlSelfRef.pll_top__DOT__dynamic_ki),5);
    bufp->fullCData(oldp+7,(vlSelfRef.pll_top__DOT__unlock_timer),6);
    bufp->fullIData(oldp+8,(vlSelfRef.pll_top__DOT__dco_inst__DOT__accumulator),32);
    bufp->fullIData(oldp+9,(vlSelfRef.pll_top__DOT__lf_inst__DOT__integrator),32);
    bufp->fullIData(oldp+10,((vlSelfRef.pll_top__DOT__lf_inst__DOT____VdfgRegularize_hbae78005_0_0 
                              << (IData)(vlSelfRef.pll_top__DOT__dynamic_kp))),32);
    bufp->fullIData(oldp+11,((vlSelfRef.pll_top__DOT__lf_inst__DOT____VdfgRegularize_hbae78005_0_0 
                              << (IData)(vlSelfRef.pll_top__DOT__dynamic_ki))),32);
    bufp->fullIData(oldp+12,(vlSelfRef.pll_top__DOT__lf_inst__DOT__next_integrator),32);
    bufp->fullCData(oldp+13,(vlSelfRef.pll_top__DOT__lf_inst__DOT__zero_error_count),5);
    bufp->fullCData(oldp+14,(vlSelfRef.pll_top__DOT__pfd_inst__DOT__ref_sync),3);
    bufp->fullCData(oldp+15,(vlSelfRef.pll_top__DOT__pfd_inst__DOT__fb_sync),3);
    bufp->fullBit(oldp+16,((1U == (3U & ((IData)(vlSelfRef.pll_top__DOT__pfd_inst__DOT__ref_sync) 
                                         >> 1U)))));
    bufp->fullBit(oldp+17,((1U == (3U & ((IData)(vlSelfRef.pll_top__DOT__pfd_inst__DOT__fb_sync) 
                                         >> 1U)))));
    bufp->fullCData(oldp+18,(vlSelfRef.pll_top__DOT__pfd_inst__DOT__state),2);
    bufp->fullBit(oldp+19,(vlSelfRef.sys_clk));
    bufp->fullBit(oldp+20,(vlSelfRef.rst_n));
    bufp->fullBit(oldp+21,(vlSelfRef.ref_clk));
    bufp->fullIData(oldp+22,(vlSelfRef.div_val),32);
    bufp->fullIData(oldp+23,(vlSelfRef.initial_freq),32);
    bufp->fullBit(oldp+24,(vlSelfRef.pll_out));
    bufp->fullBit(oldp+25,(vlSelfRef.lock_detect));
    bufp->fullIData(oldp+26,(vlSelfRef.debug_dco_word),32);
    bufp->fullBit(oldp+27,(vlSelfRef.pll_top__DOT__fb_clk_internal));
    bufp->fullIData(oldp+28,(vlSelfRef.pll_top__DOT__div_inst__DOT__counter),32);
}
